...
def get_hourly_weather_records_by_date(start_date: str, end_date: str, lat: float = LATITUDE, long: float = LONGITUDE) -> DataFrame:
    ...
    params = {
        ...
        "hourly": ["shortwave_radiation", "direct_radiation", "diffuse_radiation", "direct_normal_irradiance",
                   "global_tilted_irradiance", "terrestrial_radiation", "soil_temperature_0cm", "soil_temperature_54cm",
                   "soil_temperature_18cm", "soil_temperature_6cm"],
    ...
    hourly_soil_temperature_54cm = hourly.Variables(7).ValuesAsNumpy()
    hourly_soil_temperature_18cm = hourly.Variables(8).ValuesAsNumpy()
    hourly_soil_temperature_6cm = hourly.Variables(9).ValuesAsNumpy()
    ...
    hourly_data = {"date": pd.date_range(
        ...
        "terrestrial_radiation": hourly_terrestrial_radiation, "soil_temperature_0cm": hourly_soil_temperature_0cm,
        "soil_temperature_54cm": hourly_soil_temperature_54cm, "soil_temperature_18cm": hourly_soil_temperature_18cm,
...
def insert_hourly_weather_records(records: pd.DataFrame):
    ...
    for row in records.itertuples(index=False):
        payload = {
            ...
            "soil_temperature_0cm": float(getattr(row, "soil_temperature_0cm")),
            "soil_temperature_6cm": float(getattr(row, "soil_temperature_6cm")),
            "soil_temperature_18cm": float(getattr(row, "soil_temperature_18cm")),
            "soil_temperature_54cm": float(getattr(row, "soil_temperature_54cm")),
        }
